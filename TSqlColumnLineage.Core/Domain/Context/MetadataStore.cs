...
namespace TSqlColumnLineage.Domain.Context
{
    ...
    public sealed class MetadataStore
    {
        ...
        private readonly ConcurrentDictionary<string, TableMetadata> _tables = 
            new ConcurrentDictionary<string, TableMetadata>(StringComparer.OrdinalIgnoreCase);
            
        // Columns metadata
        private readonly ConcurrentDictionary<(string TableName, string ColumnName), ColumnMetadata> _columns = 
            new ConcurrentDictionary<(string, string), ColumnMetadata>();
        ...
        /// Adds table metadata
        /// </summary>
        public void AddTable(string tableName, string schema = "dbo", string database = null)
        {
