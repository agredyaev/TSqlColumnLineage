...
namespace TSqlColumnLineage.Infrastructure.Memory
{
    /// <summary>
    ...
    public sealed class MemoryManager
    {
        ...
        private readonly ConcurrentDictionary<Type, ObjectPool> _objectPools = 
            new ConcurrentDictionary<Type, ObjectPool>();
            
        // Array pools for commonly used array types
        private readonly ConcurrentDictionary<Type, ArrayPool> _arrayPools = 
            new ConcurrentDictionary<Type, ArrayPool>();
            
        // Lock for stats updates
        private readonly ReaderWriterLockSlim _statsLock = new ReaderWriterLockSlim();
